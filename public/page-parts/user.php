...
?>
    <li class="nav-item">
        <a class="nav-link text-dark" href="#" id="connectWalletModalbtn" data-toggle="modal" data-target="#connectWalletModal"><i class="fas fa-wallet"></i> <span class="mobileHideIt">Wallet</span></a>
    </li>
<?php
} else {
?>
