    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(JSON.parse(rs.response.data), function(k, v) {
                ...
                listItems = '<div class="col-md-3 reset-padding"><a href="/unique_model/' + clnmodel + '"><div class="product-item" style="height:100%;"><h4>iPhone ' + v.model + '</h4><img class="zoom-in" src="/public/static/modelsimg/' + v.img + '"></div></a></div>';
